## **Project Demo**
[Live Demo](https://masterbet-app.netlify.app/)

## **Description**
**Master Bet** React application that allows users to see betting results, play bet .Built this application with React, Tailwind CSS
...
```
git clone https://github.com/Ridwanullahi-code/masterBet.git
```

or

```
git clone git@github.com:Ridwanullahi-code/masterBet.git
```
## **INSTALL**
```
npm install
...
Feel free to check the [issues page](https://github.com/Ridwanullahi-code/masterBet/issues/)
## **Acknowledgements**
